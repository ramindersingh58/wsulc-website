 ...
 * @author Raminder
 */
public class SaveStations extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            {
                rs.updateString("ss", ss);
                rs.updateString("ds", ds);
                rs.updateRow();
                out.println("success");
            } else {

                out.println("train with "+ti+" not registered");
            }
