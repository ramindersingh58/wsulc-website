 ...
 * @author Raminder
 */
public class ChangePersonName extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ResultSet rs = stmt.executeQuery("select * from vehicle_user where username='" + un + "'");
